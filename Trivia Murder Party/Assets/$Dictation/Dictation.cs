...
public class Dictation : MonoBehaviour {
   ...
   private string[][] PhraseList = new string[][] {
      ...
      new string[] {"UH" , "OH" , "DICTATION" , "HAS" , "RUN" , "INTO" , "AN" , "ERROR" , "THIS" , "BOMB" , "IS" , "NOW" , "UNSOLVABLE" , "PLEASE" , "ACCEPT" , "YOUR" , "SolveAnimationE" , "AND" , "DO" , "NOT" , "TRY" , "TO" , "SOLVE" , "ANYMORE" , "MODULES" , "ON" , "THIS" , "BOMB" , "ANY" , "ATTEMPT" , "TO" , "SOLVE" , "THIS" , "BOMB" , "WILL" , "RESULT" , "IN" , "CATASTROPHIC" , "FAILURE" , "THANK" , "YOU" , "FOR" , "YOUR" , "COOPERATION"},
